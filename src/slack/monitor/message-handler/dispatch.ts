...
export async function dispatchPreparedSlackMessage(prepared: PreparedSlackMessage) {
  ...
  // ---------------------------------------------------------------------------
  // Draft stream (non-streaming preview via message edits)
  // ---------------------------------------------------------------------------
  ...
  const { queuedFinal, counts } = await dispatchInboundMessage({
    ...
    replyOptions: {
      ...
      onAssistantMessageStart: useStreaming ? undefined : async () => resetDraftStreamState(),
      onReasoningEnd: useStreaming ? undefined : async () => resetDraftStreamState(),
    },
  });

  // ---------------------------------------------------------------------------
  // Post-processing: flush draft stream & finalize native stream
  // ---------------------------------------------------------------------------
